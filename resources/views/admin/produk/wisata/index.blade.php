<x-app-layout title="Produk" subTitle="Wisata">
    <x-card-component col="12" title="Data Wisata Produk {{ $produk->name }}" :dataTable="$dataTable">
        <div class="row">
            <div class="col-6">
    ...
    @endslot
    @include('admin.produk.wisata.create')
    @include('admin.produk.wisata.edit')
</x-app-layout>