<x-app-layout title="Produk" subTitle="Image">
    <x-card-component col="12" title="Data Image Produk {{ $produk->name }}" :dataTable="$dataTable">
        <div class="row">
            <div class="col-6">
    ...
    @endslot
    @include('admin.produk.image.create')
    @include('admin.produk.image.edit')
</x-app-layout>