<x-app-layout title="Produk" subTitle="Fasilitas">
    <x-card-component col="12" title="Data Fasilitas Produk {{ $produk->name }}" :dataTable="$dataTable">
        <div class="row">
            <div class="col-6">
    ...
    @endslot
    @include('admin.produk.fasilitas.create')
    @include('admin.produk.fasilitas.edit')
</x-app-layout>