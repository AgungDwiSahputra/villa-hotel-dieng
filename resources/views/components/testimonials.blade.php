...
<section class="relative py-16 lg:py-24 bg-gradient-to-br from-primary-900 via-primary-800 to-primary-900 text-white overflow-hidden" aria-labelledby="testimonials-heading">
    ...
    <div class="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="testimonials-carousel mb-12 lg:mb-16" role="region" aria-label="Testimonial carousel">
            <!-- Carousel Navigation -->
            <div class="flex items-center justify-between mb-6 lg:mb-8">
                <h3 class="text-xl lg:text-2xl font-semibold text-white">Ulasan Terbaru</h3>
                <div class="flex space-x-2">
                    <button id="testimonial-prev" class="w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-full flex items-center justify-center transition-all duration-200 border border-white/20">
                        <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                        </svg>
                    </button>
                    <button id="testimonial-next" class="w-10 h-10 lg:w-12 lg:h-12 bg-white/10 backdrop-blur-sm hover:bg-white/20 rounded-full flex items-center justify-center transition-all duration-200 border border-white/20">
                        <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <!-- Trust Badges -->
        <div class="trust-badges mb-12 lg:mb-16">
...
<div class="fixed bottom-6 right-6 z-40 lg:hidden">
    <button class="w-14 h-14 bg-accent-600 hover:bg-accent-700 text-white rounded-full shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-200 flex items-center justify-center" role="button" aria-label="Tulis ulasan">
