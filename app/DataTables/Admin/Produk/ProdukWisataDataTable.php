...
class ProdukWisataDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'admin.produk.wisata.action')
            ->addIndexColumn();
    }

    public function query(ProdukWisata $model): QueryBuilder
    {
    ...
    {
        return 'Produk_Wisata' . date('YmdHis');
    }
}