...
class ProdukFasilitasDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'admin.produk.fasilitas.action')
            ->addIndexColumn();
    }

    public function query(ProdukFasilitas $model): QueryBuilder
    {
    ...
    {
        return 'Produk_Fasilitas' . date('YmdHis');
    }
}
