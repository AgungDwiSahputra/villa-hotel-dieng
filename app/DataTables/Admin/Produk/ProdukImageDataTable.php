...
class ProdukImageDataTable extends DataTable
{
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'admin.produk.image.action')
            ->addIndexColumn();
    }

    public function query(ProdukImage $model): QueryBuilder
    {
    ...
    {
        return 'Produk_Image' . date('YmdHis');
    }
}